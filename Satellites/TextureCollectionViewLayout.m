...
@implementation TextureCollectionViewLayout
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[@"TextureCell"] = cellLayoutInfo;
...
{
    return self.layoutInfo[@"TextureCell"][indexPath];
}
